...
contract GovernorBravoDelegateStorageV1 is GovernorBravoDelegatorStorage {
    ...
    /// @notice The address of the hunter Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the hunter governance token
    hunterBInterface public hunterB;
...
interface hunterBInterface {
    function iHunterMandator(address _user) external view returns (bool);
...
interface TreasuryInterface {
    function hunterPriceInUSD(uint _amount) external returns (uint);
}
