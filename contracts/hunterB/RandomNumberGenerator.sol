    ...
    ReentrancyGuardUpgradeable
{
    ...
    /**
     * @dev Throws if called by any account other than the hunterB contract.
     */
    modifier eligibleForEnableInitialize() {
        require(isAvailableForInitialize, "Random: caller is not the hunterB");
        _;
    }
    ...
    modifier eligibleForRequest() {
        require(
            ...
            "Random: caller is not the hunterB"
        );
        _;
    }
    ...
    modifier verifyMinimumHolder() {
        require(
            hunterBInterface(hunterB).counter() > minimumStakersRequired,
    ...
    /**
     * @param _hunterB address of hunterB contract.
     */
    function initialize(address _hunterB) public initializer {
        require(_hunterB != address(0), "Invalid _hunterB address");
        __Ownable_init();
    ...
    function initializeRandomAddressSelection()
        ...
        nonReentrant
    {
        hunterBInterface(hunterB).initializeRandomAddressSelection(
