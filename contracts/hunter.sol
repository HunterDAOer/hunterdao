...
contract Hunter is Initializable,UUPSUpgradeable,ERC20Upgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable,ERC20VotesCompUpgradeable, OwnableUpgradeable, PausableUpgradeable {
    using SafeMathUpgradeable for uint256;
    address public fee;
    uint256 public tax;
    mapping(address => bool) public whitelistedAddress;

    event FeeAddressUpdated(address newFee);
    ...
    function initialize(        
        ...
        ERC20Upgradeable.__ERC20_init("Hunter DAO", "Hunter");
        ERC20PermitUpgradeable.__ERC20Permit_init("hunter");
    ...
    function setFeeAddress(address _fee) external onlyOwner{
        require(_fee != address(0), "setFeeAddress: Zero address");
        fee = _fee;
        whitelistedAddress[_fee] = true;
